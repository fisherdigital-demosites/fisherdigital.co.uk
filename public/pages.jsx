...
const AboutPage = ({ tw }) => (
  <>
    ...
    <section className="section container">
      <div className="about-story reveal" style={{ maxWidth: 720, margin: "0 auto", textAlign: "center" }}>
        <span className="eyebrow">Our story</span>
        <h2 style={{ marginTop: 8 }}>We started FisherDigital because local businesses deserve better.</h2>
        <p style={{ textAlign: "left" }}>The businesses that keep our high streets running, plumbers, dentists, hairdressers, electricians, are losing work to missed calls, slow follow-ups, and no time for marketing. The tools to fix this have always existed, but they were built for big companies with IT departments and six-figure budgets.</p>
        <p style={{ textAlign: "left" }}>We set up the same systems for local businesses. AI that answers the phone at 2am. Automated follow-ups that chase quotes while you are on the tools. Review requests that go out after every job without anyone lifting a finger. All managed by us, so the business owner never needs to learn a single new platform.</p>
        <p style={{ textAlign: "left" }}>FisherDigital started with Josh, who built the technical foundations, and grew when Billy joined as co-founder to drive growth and client relationships. Between us, we handle everything from configuring the AI to running sales calls and making sure every client gets results.</p>
      </div>
    </section>
